...
3. `HD-MTH-002` landed at `docs/methodology/HD-MTH-002-framework-parallel.md` because the requested path was connector-blocked.
4. Some files are concise activation surfaces because fuller payloads were connector-blocked. The claim boundary and validation surface are preserved.
5. No out-of-scope control-plane content was copied into the repository.
